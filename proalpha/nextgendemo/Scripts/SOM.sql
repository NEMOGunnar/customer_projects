WITH
    ...
    FORECAST AS (
        ...
        FROM
            NEXTGENDEMO.PA_BATCH_FORECAST F
            ...
            LEFT JOIN NEXTGENDEMO.PA_BATCH_FORECAST_VALIDATION V ON V.metric = p_som_metric
...
PARTS_DATA AS (
	...
	FROM
		NEXTGENDEMO."pa_export" pe
	JOIN NEXTGENDEMO."nemo_master_data" nmd 
