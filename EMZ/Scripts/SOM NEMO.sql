WITH
    ...
    PAX_DATA AS (
        SELECT
            ...
            pa.part_selection,
            pa.s_artikel_sb_produktmanager
        FROM
            (
                SELECT
                    company,
                    ...
                    part_selection,
                    s_artikel_sb_produktmanager
                FROM
                    $schema.$table
                WHERE
                    part_i_d IS NOT NULL
--                    AND company = '40'
--                    AND part_i_d IN ('11.0023.4.000','11.0303.4.000','11.0306.4.000','12.0026.4.000','15.4900.4.000','15.5748.4.000')
            ) PA
            LEFT JOIN (
                SELECT
                    company,
    ...
    FORECAST AS (
        ...
        FROM
            ...
            LEFT JOIN $schema.PA_BATCH_FORECAST_VALIDATION V ON V.metric = p_som_metric
    ...
    PART_FILTER_INFO AS (
        ...
        SELECT
            ...
            PART_DESC2, -- PartDesc2            Teilebeschreibung
    ...
    MODEL_RAW AS (
        SELECT
            ...
            F.s_artikel_sb_produktmanager,
            F.part_replenishment_time,
            F.mvmt_average_costs_total_corp_cur,
            S.mvmt_m_r_p_group,
            S.mvmt_m_r_p_group_desc,
...
SELECT
	...
	, part_replenishment_time
	, Avg_General_Replenishment_Time
	, Avg_General_Replenishment_Time - part_replenishment_time AS diff_replenishment_time
	, part_supp_min_order_qty
	, part_supp_order_multiple
	, part_supp_order_multiple - part_supp_min_order_qty AS diff_MOQ
	, (part_supp_order_multiple - part_supp_min_order_qty) * mvmt_average_costs_total_corp_cur AS potential_savings
/*	, 
    company,
    part_i_d,
    mvmt_m_r_p_area,
